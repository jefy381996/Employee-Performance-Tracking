...
echo "<h2>🔍 Debug Results Error</h2>";
...
echo "<h3>✅ 5. Students Count Test</h3>";
...
if ($students_count == 0) {
    ...
    echo "<p><strong>⚠️ No students found!</strong> You need to add students before adding results.</p>";
    echo "</div>";
}

echo "<h3>✅ 6. Test Result Insert</h3>";
...
echo "<h3>✅ 8. Manual Test Steps</h3>";
echo "<ol>";
